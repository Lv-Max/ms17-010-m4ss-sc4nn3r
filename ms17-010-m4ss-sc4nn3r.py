...
banner = """
   __  __  _____ __ ______       ___  __  ___  
 |  \/  |/ ____/_ |____  |     / _ \/_ |/ _ \ 
 | \  / | (___  | |   / /_____| | | || | | | |
 | |\/| |\___ \ | |  / /______| | | || | | | |
 | |  | |____) || | / /       | |_| || | |_| |
 |_|  |_|_____/ |_|/_/         \___/ |_|\___/ 
                       ...
                       MS17-010-多线程检测工具 v1.0
                 https://github.com/Lv-Max/ms17-010-m4ss-sc4nn3r

"""

usage = "[+] 使用方式: "+sys.argv[0]+" ip or ip/CIDR or ip/subnet\n\n"
usage += "    示范: "+sys.argv[0]+" 192.168.0.1\n"
